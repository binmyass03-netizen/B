...
do
    ...
    pcall(function()
        local old = parentGui:FindFirstChild("HeroHubBottomHUD")
        if old then old:Destroy() end
    end)

    local hud = Instance.new("ScreenGui")
    hud.Name = "HeroHubBottomHUD"
    ...
    title.Text = "HERO HUB"
    title.TextSize = 28
    title.TextColor3 = Color3.fromRGB(186, 120, 255)
    title.TextXAlignment = Enum.TextXAlignment.Left

    local byline = Instance.new("TextLabel")
    byline.Parent = bar
    byline.BackgroundTransparency = 1
    byline.Position = UDim2.new(0, 24, 0, 38)
    byline.Size = UDim2.new(0, 260, 0, 20)
    byline.Font = Enum.Font.Gotham
    byline.Text = "made by hero"
    byline.TextSize = 15
    byline.TextColor3 = Color3.fromRGB(215, 215, 225)
    byline.TextXAlignment = Enum.TextXAlignment.Left

    local divider = Instance.new("Frame")
    divider.Parent = bar
    divider.BackgroundColor3 = Color3.fromRGB(45, 45, 62)
    divider.BorderSizePixel = 0
    divider.Position = UDim2.new(1, -200, 0.12, 0)
    divider.Size = UDim2.new(0, 1, 0.76, 0)

    local fpsLabel = Instance.new("TextLabel")
    fpsLabel.Parent = bar
    fpsLabel.BackgroundTransparency = 1
    fpsLabel.Position = UDim2.new(1, -180, 0, 10)
    fpsLabel.Size = UDim2.new(0, 160, 0, 22)
    fpsLabel.Font = Enum.Font.GothamBold
    fpsLabel.Text = "FPS: ..."
    fpsLabel.TextSize = 15
    fpsLabel.TextColor3 = Color3.fromRGB(90, 255, 140)
    fpsLabel.TextXAlignment = Enum.TextXAlignment.Left

    local pingLabel = Instance.new("TextLabel")
    pingLabel.Parent = bar
    pingLabel.BackgroundTransparency = 1
    pingLabel.Position = UDim2.new(1, -180, 0, 32)
    pingLabel.Size = UDim2.new(0, 160, 0, 22)
    pingLabel.Font = Enum.Font.GothamBold
    pingLabel.Text = "PING: ..."
    pingLabel.TextSize = 15
    pingLabel.TextColor3 = Color3.fromRGB(120, 255, 170)
